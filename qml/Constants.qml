...
QtObject {
    ...
    readonly property color menuColor: "#363636"
    readonly property color lightAccentColor: "#af5bd9"
    readonly property color accentColor: "#a338d9"
    readonly property color darkAccentColor: "#7e00bd"
    ...
    readonly property color iconColor: "#d692d1"
    readonly property color iconColorInvert: "#e0e0e0"
}
